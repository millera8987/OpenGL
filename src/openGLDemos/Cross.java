...
public class Cross implements GLEventListener, KeyListener {
   ...
   // *************** End variable declarations and initializations ***********
    ...
    public void drawQuad(GL2 gl, Color color){
    ...
    public void vertex(GL2 gl, double x, double y, double z){
    	gl.glVertex3d(-1, 1, 0);
    }
    
    public void newCross(GL2 gl){
    ...
    public static void main(String[] args) {
    	...
    	canvas.addGLEventListener(new Cross()); // <-- ADD CLASS NAME HERE!!!
