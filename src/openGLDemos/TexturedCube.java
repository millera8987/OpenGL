...
public class TexturedCube implements GLEventListener, KeyListener {
   ...
   // *************** End variable declarations and initializations ***********
    public void init(GLAutoDrawable gLDrawable) {
        ...
        texture[0] = getMyTextures(gl, "images/vaderClip.png");
        texture[1] = getMyTextures(gl, "images/yodaSolo.png");
        texture[2] = getMyTextures(gl, "images/ackbarClip.png");
        texture[3] = getMyTextures(gl, "images/c3poClip.png");
        texture[4] = getMyTextures(gl, "images/chewyClip.png");
        texture[5] = getMyTextures(gl, "images/obiClip.png");
...
*/
    ...
    void myCube(GL2 gl, double x, double y, double z, double size)
    {
    	int xtile = 1;
    	int ytile = 1;
    	//glColor3dv(white);
    	...
    	gl.glBegin(GL2.GL_QUADS);
	    	...
	    	gl.glEnd();
	    	gl.glBindTexture(GL2.GL_TEXTURE_2D, texture[1]);//grass
	    	gl.glBegin(GL2.GL_QUADS);
	    	...
	    	gl.glEnd();
	    	gl.glBindTexture(GL2.GL_TEXTURE_2D, texture[2]);//grass
	    	gl.glBegin(GL2.GL_QUADS);
	    		//right
	    	...
	    	gl.glTexCoord2d(xtile,0);gl.glVertex3d(x+size,y-size,z-size);
	    	gl.glEnd();
	    	gl.glBindTexture(GL2.GL_TEXTURE_2D, texture[3]);//grass
	    	gl.glBegin(GL2.GL_QUADS);
	    		//left
	    	...
	    	gl.glTexCoord2d(xtile,0);gl.glVertex3d(x-size,y-size,z-size);
	    	gl.glEnd();
	    	gl.glBindTexture(GL2.GL_TEXTURE_2D, texture[4]);//grass
	    	gl.glBegin(GL2.GL_QUADS);
	    		//top
	    	...
	    	gl.glTexCoord2d(xtile,ytile);gl.glVertex3d(x+size,y+size,z+size);
	    	gl.glEnd();
	    	gl.glBindTexture(GL2.GL_TEXTURE_2D, texture[5]);//grass
	    	gl.glBegin(GL2.GL_QUADS);
	    		//bottom
    ...
    void wireCube(GL2 gl, double x, double y, double z, double size)
    {
    	int xtile = 1;
    	int ytile = 1;
    	//glColor3dv(white);
    ...
    public void coordinatePlane(GL2 gl){
    	...
    	gl.glBegin(GL2.GL_LINES);
    	//red x axis
    	gl.glColor3d(size, 0, 0);
    	gl.glVertex3d(-size, 0, 0);
    	gl.glVertex3d(size, 0, 0);
    	
    	//green y axis
    	gl.glColor3d(0, size, 0);
    	gl.glVertex3d(0, -size, 0);
    	gl.glVertex3d(0, size, 0);
    	
    	//blue z axis
    	gl.glColor3d(0, 0, size);
    ...
    public static void main(String[] args) {
    	...
    	canvas.addGLEventListener(new TexturedCube()); // <-- ADD CLASS NAME HERE!!!
